...
export default function Routes() {
  ...
  const [fuelPrice, setFuelPrice] = useState(290); // Updated to current market price
  const [vehicleType, setVehicleType] = useState('truck');
  const [expandedRoute, setExpandedRoute] = useState<string | null>(null);

  const routes: RouteData[] = [
    // China to Pakistan CPEC Routes
    // Fuel = distance × 0.35 L/km × 290 PKR/L; Toll = ceil(distance/100) × 3000 PKR
    { id: '1', from: 'Kashgar, China', to: 'Islamabad, Pakistan', distance: 1250, duration: '5-7 days', fuelCost: 127000, tollCost: 39000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: true },
    { id: '2', from: 'Urumqi, China', to: 'Lahore, Pakistan', distance: 1800, duration: '7-10 days', fuelCost: 183000, tollCost: 54000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Partly Cloudy', trafficLevel: 'medium', popularRoute: true },
    { id: '3', from: 'Kashgar, China', to: 'Lahore, Pakistan', distance: 1450, duration: '6-8 days', fuelCost: 147000, tollCost: 45000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: true },
    { id: '4', from: 'Kashgar, China', to: 'Karachi, Pakistan', distance: 2100, duration: '10-12 days', fuelCost: 213000, tollCost: 63000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: true },
    { id: '5', from: 'Urumqi, China', to: 'Peshawar, Pakistan', distance: 1650, duration: '7-9 days', fuelCost: 167500, tollCost: 51000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Windy', trafficLevel: 'low', popularRoute: false },
    { id: '6', from: 'Kashgar, China', to: 'Gwadar, Pakistan', distance: 2450, duration: '12-15 days', fuelCost: 249000, tollCost: 75000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Hot', trafficLevel: 'low', popularRoute: true },
    { id: '7', from: 'Kashgar, China', to: 'Faisalabad, Pakistan', distance: 1550, duration: '7-9 days', fuelCost: 157500, tollCost: 48000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '8', from: 'Kashgar, China', to: 'Multan, Pakistan', distance: 1650, duration: '8-10 days', fuelCost: 167500, tollCost: 51000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '9', from: 'Kashgar, China', to: 'Quetta, Pakistan', distance: 1900, duration: '9-11 days', fuelCost: 193000, tollCost: 57000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '10', from: 'Urumqi, China', to: 'Karachi, Pakistan', distance: 2300, duration: '11-14 days', fuelCost: 233500, tollCost: 69000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: false },
    { id: '11', from: 'Urumqi, China', to: 'Islamabad, Pakistan', distance: 1500, duration: '6-8 days', fuelCost: 152500, tollCost: 45000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: true },
    { id: '12', from: 'Kashgar, China', to: 'Rawalpindi, Pakistan', distance: 1260, duration: '5-7 days', fuelCost: 128000, tollCost: 39000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '13', from: 'Kashgar, China', to: 'Sialkot, Pakistan', distance: 1400, duration: '6-8 days', fuelCost: 142000, tollCost: 42000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '14', from: 'Kashgar, China', to: 'Hyderabad, Pakistan', distance: 2000, duration: '10-12 days', fuelCost: 203000, tollCost: 60000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Hot', trafficLevel: 'low', popularRoute: false },
    { id: '15', from: 'Kashgar, China', to: 'Sukkur, Pakistan', distance: 1850, duration: '9-11 days', fuelCost: 188000, tollCost: 57000, borderCrossing: 'Khunjerab Pass', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    // Domestic Pakistan Routes
    { id: '16', from: 'Islamabad, Pakistan', to: 'Karachi, Pakistan', distance: 1200, duration: '2-3 days', fuelCost: 122000, tollCost: 36000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: true },
    { id: '17', from: 'Lahore, Pakistan', to: 'Karachi, Pakistan', distance: 1100, duration: '2-3 days', fuelCost: 112000, tollCost: 33000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: true },
    { id: '18', from: 'Islamabad, Pakistan', to: 'Lahore, Pakistan', distance: 380, duration: '5-6 hours', fuelCost: 39000, tollCost: 12000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: true },
    { id: '26', from: 'Lahore, Pakistan', to: 'Islamabad, Pakistan', distance: 380, duration: '5-6 hours', fuelCost: 39000, tollCost: 12000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: true },
    { id: '19', from: 'Islamabad, Pakistan', to: 'Peshawar, Pakistan', distance: 165, duration: '2-3 hours', fuelCost: 17000, tollCost: 6000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: true },
    { id: '20', from: 'Karachi, Pakistan', to: 'Gwadar, Pakistan', distance: 650, duration: '1-2 days', fuelCost: 66000, tollCost: 21000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Hot', trafficLevel: 'low', popularRoute: true },
    { id: '21', from: 'Lahore, Pakistan', to: 'Faisalabad, Pakistan', distance: 130, duration: '2 hours', fuelCost: 13000, tollCost: 6000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: false },
    { id: '22', from: 'Lahore, Pakistan', to: 'Multan, Pakistan', distance: 350, duration: '5-6 hours', fuelCost: 36000, tollCost: 12000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '23', from: 'Islamabad, Pakistan', to: 'Quetta, Pakistan', distance: 800, duration: '1-2 days', fuelCost: 81000, tollCost: 24000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'low', popularRoute: false },
    { id: '24', from: 'Quetta, Pakistan', to: 'Gwadar, Pakistan', distance: 700, duration: '1-2 days', fuelCost: 71000, tollCost: 21000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Hot', trafficLevel: 'low', popularRoute: false },
    { id: '25', from: 'Peshawar, Pakistan', to: 'Lahore, Pakistan', distance: 480, duration: '7-8 hours', fuelCost: 49000, tollCost: 15000, borderCrossing: 'N/A', status: 'open', weatherCondition: 'Clear', trafficLevel: 'medium', popularRoute: false },
  ];
